const translations = {
  es: {
    ...
    faq1Answer: "En el Molí Vell de Benifayó. Pondremos algún autobús (ruta pendiente de confirmación) para quien no tenga cómo llegar, pero también hay allí un parking grande para quien quiera venir con su propio vehículo.",
  ...
  ca: {
    ...
    faq1Answer: "Al Molí Vell de Benifayó. Posem a disposició algún autobús (ruta pendent de confirmació) per a qui no tingui com arribar, però també hi ha un parking gran per a qui vuiga vindre amb el seu propi vehicle.",
